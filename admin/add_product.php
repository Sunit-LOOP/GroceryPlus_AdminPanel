...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO products (product_name, description, price, stock_quantity) VALUES (?, ?, ?, ?)");
...
<head>
    ...
    <title>Add Product - GroceryPlus Admin</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        button { flex: 1; padding: 1rem; background: linear-gradient(135deg, #4CAF50, #388E3C); color: white; border: none; border-radius: 12px; cursor: pointer; font-size: 1rem; font-weight: 500; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(76, 175, 80, 0.3); display: flex; align-items: center; justify-content: center; gap: 0.5rem; }
...
<body>
    <div class="header">
        <h1><img src="../images/splash_logo.png" alt="Logo">Add New Product</h1>
